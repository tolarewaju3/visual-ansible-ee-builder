...
export function StepNavigation({
  ...
  return <div className="w-full bg-transparent rounded-none">
      <div className="container mx-auto px-6 py-0">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          return <div key={step.id} className="flex items-center flex-1">
                <button onClick={() => isClickable && onStepChange(stepNumber)} disabled={!isClickable} className={cn("flex items-center space-x-3 p-2 rounded-lg transition-all", isClickable ? "hover:bg-muted/50 cursor-pointer" : "cursor-not-allowed opacity-50")}>
